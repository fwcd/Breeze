...
import com.fwcd.breeze.viewutils.CustomTabSizeEditorKit;
...
public class CodePane implements Viewable {
	...
	private final BEditor parent;
	
	private CodeDoc doc;
	
	public CodePane(BEditor parent) {
		this.parent = parent;
		defaultStyle = new TextStyle(parent.getTheme().fgColor());
		
		view = new RenderPanel(this::renderBG);
